...
if(isset($_POST['submit'])){
    ...
    $stmt = $conn->prepare(" INSERT INTO `courses`(`courseName`, `courseDay`, `courseTime`, `courseClass`, `courseTime_inWeek`, `user_id`) VALUES ('$course_name', '$course_day', '$course_time', '$course_class','$course_in_week','$user_id') ");
    $executed = $stmt->execute();
    if($executed){
        $msg = '<div class="alert alert-success" role="alert">
        Add Done Seccfully. <a href="index.php" class="btn-link"> Back </a>
     </div>';
    }else{
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="coure_name">
                                </div>
                                ...
                                <div class="form-group pt-2">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="time" id="only-time" data-field="time" placeholder="Select The Time" readonly="">
                                </div>
                                <div class="form-group pt-2">
                                    <label>Class Room</label>
                                    <input type="text" class="form-control" name="coure_class"  >
                                </div>
                                <div class="form-group pt-2">
                                    <label>Course Time in Week</label>
                                    <input type="text" class="form-control" name="coure_time_week"   >
                                </div>
                                <br>
