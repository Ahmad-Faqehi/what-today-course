...
if(isset($_POST['submit'])){
    ...
    $stmt = $conn->prepare(" UPDATE `users` SET `firstName`='$first_name',`lastName`='$last_name',`email`='$email',`password`= '$password' WHERE id = $user_id ");
    $executed = $stmt->execute();
    if($executed){
        $msg = '<div class="alert alert-success" role="alert">
        Edit Done Seccfully. <a href="index.php" class="btn-link"> Back </a>
     </div>';
    }else{
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <form action="" method="POST">
                                ...
                                <div class="form-group pt-2">
                                    <label>Emaill</label>
                                    <input type="email" class="form-control form-control-user" name="email" value="<?=$row['email']?>" >
                                </div>
                                <div class="form-group pt-2">
                                    <label>New Password <small>Optinal</small></label>
