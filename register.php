<?php include "connection.php"; 
    ...
    if(isset($_POST['submit'])){
        ...
        $num_user = $conn->query("select count(*) from  users where email = '$email' ")->fetchColumn();
        ...
        if($password !== $re_password){
            ...
            $stmt = $conn->prepare("INSERT INTO `users` (`email`, `firstName`, `lastName`, `password`) VALUES ( '$email','$fname','$lname','$password') ");
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="inputPasswordConfirm" type="password" name="Re_password" placeholder="Confirm password" />
