...
$cources = $conn->query("select * from  courses where user_id = '$user_id'  ORDER BY `courses`.`courseDay` ASC ")->fetchAll();
$times = $conn->query("select courseTime_inWeek from  courses where user_id = '$user_id' ")->fetchAll();
$total_time = 0;
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Edit Your Courses</li>
                        </ol>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <td><span style="display: none"><?=$cource['courseDay'] ?></span><?php echo numToDay($cource['courseDay']) ?></td>
                                            ...
                                            <td> <a href="editCourse.php?id=<?php echo $cource['id'] ?>" class="btn-lnik"> Edit </a> &nbsp;	 | &nbsp;	<a href="deleteCourse.php?id=<?php echo $cource['id'] ?>" class="btn-lnik text-danger"> Delete </a> </td>
                                        </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
